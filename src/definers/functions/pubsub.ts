import {type BlueprintPubSubFunctionConfig, type BlueprintPubSubFunctionResource, validatePubSubFunction} from '../../index.js'
 ...
 * @returns The validated pubsub function resource
 */
export function definePubSubFunction(functionConfig: BlueprintPubSubFunctionConfig): BlueprintPubSubFunctionResource {
  const functionResource: BlueprintPubSubFunctionResource = {
    ...defineFunction(functionConfig, {skipValidation: true}),
    type: 'sanity.function.pubsub',
  }

  runValidation(() => validatePubSubFunction(functionResource))
