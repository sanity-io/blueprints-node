...
/**
 * Small parse-duration wrapper for string or number
 * @param duration
 * @param unit
 * @return parsed number in the specified unit
 */
export function parseDuration(duration: string | number, unit: DurationUnit = 's'): number {
