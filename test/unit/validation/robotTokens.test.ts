...
import * as robotTokens from '../../../src/validation/robotTokens.js'

describe('validateRobotToken', () => {
  afterEach(() => {
    vi.resetAllMocks()
  })
  ...
  test('should return an error if config is falsey', () => {
    const errors = robotTokens.validateRobotToken(null)
  ...
  test('should return an error if config is not an object', () => {
    const errors = robotTokens.validateRobotToken(1)
    expect(errors).toContainEqual({
      type: 'invalid_type',
  ...
  test('should return an error if name is not a string', () => {
    const errors = robotTokens.validateRobotToken({name: 1})
  ...
  test('should return an error if type is not sanity.access.robot', () => {
    const errors = robotTokens.validateRobotToken({type: 'invalid'})
  ...
  test('should return an error if label is not a string', () => {
    const errors = robotTokens.validateRobotToken({label: 1})
  ...
  test('should return an error if memberships is not an array', () => {
    const errors = robotTokens.validateRobotToken({memberships: 1})
  ...
  test('should return an error if membership is falsey', () => {
    const errors = robotTokens.validateRobotToken({memberships: [null]})
    expect(errors).toContainEqual({
      type: 'invalid_value',
  ...
  test('should return an error if membership resource type is not project or organization', () => {
    const errors = robotTokens.validateRobotToken({memberships: [{resourceType: 'invalid'}]})
    expect(errors).toContainEqual({
      type: 'invalid_value',
  ...
  test('should return an error if membership resource ID is not a string', () => {
    const errors = robotTokens.validateRobotToken({memberships: [{resourceId: 1}]})
    expect(errors).toContainEqual({
      type: 'invalid_type',
  ...
  test('should return an error if memberships is not an array', () => {
    const errors = robotTokens.validateRobotToken({memberships: [{roleNames: 1}]})
    expect(errors).toContainEqual({type: 'invalid_type', message: 'Membership role names must be an array'})
  })

  test('should return an error if memberships is an empty array', () => {
    const errors = robotTokens.validateRobotToken({memberships: [{roleNames: []}]})
  ...
  test('should return an error if role name is falsey', () => {
    const errors = robotTokens.validateRobotToken({memberships: [{roleNames: [null]}]})
  ...
  test('should return an error if resource type is provided and resource ID is not provided', () => {
    const errors = robotTokens.validateRobotToken({resourceType: 'project'})
    expect(errors).toContainEqual({
      type: 'missing_parameter',
  ...
  test('should return an error if resource type is not project or organization', () => {
    const errors = robotTokens.validateRobotToken({resourceType: 'invalid'})
    expect(errors).toContainEqual({
      type: 'invalid_value',
  ...
  test('should return an error if resource ID is provided and resource type is not provided', () => {
    const errors = robotTokens.validateRobotToken({resourceId: 'test-resource'})
    expect(errors).toContainEqual({
      type: 'missing_parameter',
  ...
  test('should return an error if membership resource ID is not a string', () => {
    const errors = robotTokens.validateRobotToken({resourceId: 1})
    expect(errors).toContainEqual({
      type: 'invalid_type',
